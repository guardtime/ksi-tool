...
char *conf_help_toString(char *buf, size_t len) {
	...
	count += KSI_snprintf(buf + count, len - count,
		...
		"             aggregation tree size to grow over the limits specified.\n"
		" --max-aggr-rounds <int>\n"
		...
		" --mdata-sqn-nr <int>\n"
		"           - Optional sequence number of the request as integer that will be embedded\n"
		"             into the signature as metadata.\n"
		" --mdata-req-tm <int>\n"
